...
input1 <- readxl::read_excel("C:\\Users\\Admin\\Dropbox\\Datos 2INBN\\18_01_2021\\um.xlsx", col_types = "text")
...
input2 <- utils::read.csv("C:\\Users\\Admin\\Dropbox\\Datos 2INBN\\Tablas y Scripts 2INBN\\Tablas actualizadas\\TABLA_COMPLETA_2021\\INBN2_UM_pais_2021.csv") #archivo propio (compartido en diciembre 2020) con todas las UM que se utilizaron exclusivamente para el procesamiento de datos. n = 3811
um_procesadas <- base::unique(input2$um_id_um)

input3 <- read.csv("C:\\Users\\Admin\\Dropbox\\Datos 2INBN\\Tablas y Scripts 2INBN\\Tablas actualizadas\\MONTE\\MON_Individuos_SEPTIEMBRE_2020.csv")
...
input4 <- read.csv("C:\\Users\\Admin\\Desktop\\R inbn2\\informe_nac\\otbn_um_todas_ofc_22_cvn_ign.csv")

#input_test <- read.csv("C:\\Users\\Admin\\Desktop\\R inbn2\\informe_nac\\otras_variables_UM_todas_OFC.csv", quote = "")
...
#----PENDIENTE----
#count(espacial_vars, pendiente) #escalas probablemente mezcladas (grados y %), para simplificar se crean categorías en base a la escala de grados de esta forma subestimando prudentemente.
...
# write.table(espacial_vars, file = "C:\\Users\\Admin\\Desktop\\R inbn2\\informe_nac\\UM_todas_OFC_espacial_vars.csv", row.names = FALSE, col.names = TRUE, quote = FALSE, sep = ",")
# 
#write.table(otbn_tab, file = "C:\\Users\\Admin\\Desktop\\R inbn2\\informe_nac\\UM_todas_OFC_OTBN_categoria.csv", row.names = FALSE, col.names = TRUE, quote = FALSE, sep = ",")
...
nombres_jefes <- c("Abel Velasquez", "Adrian Dominguez", "Alejandro Piggot", "Ariel Amoroso", "Ariel Francisco", "Ariel Mortoro", "Arturo Segovia", "Bruno Acevedo", "Javier Albanesi", "Walter Campos", "Nestor Arriola", "Luis Carignano", "Carlos Inzaurralde", "Carlos Lima", "Pablo D'Angelo", "David Alvarez", "Eduardo Sisti", "Emiliano Blanc", "Emilio Montefinale",  "Enzo Campos", "Felipe Esteche", "Fabián Momberg", "Facundo Bertolami", "Santiago Favoretti", "Federico Gonzalez", "Felipe Galeano", "Jose Fernandez", "Fernando Barbero", "Fernando Rodriguez", "Francisco Ojeda", "Ruben Gon", "Miguel Gonzalez", "Gonzalo Caballe", "Hector Fitze", "Hector Keller", "Hernan Colomb", "Horacio Ivancich", "Leonardo Huertas", "Miguel Maldonado", "Ignacio Contreras", "Ivan Suarez", "Jorge Araujo", "Juan Solis", "Julian Quispe", "Karina Keller", "Walter Lezcano", "Lisandro Heit", "Luis Ritter", "Marcos Gonzalez", "Martin Abdo", "Matias Carignano", "Mauricio Mattenet", "Eduardo Mayol", "Miguel Mamani", "Nadia Griffiths", "Lucas Monelos",  "Walter Puyol", "Raul Arguimbao", "Renzo Eichelberger", "Santiago Ponce", "Sergio Rode", "Sergio Saiquita", "Sergio Ledesma", "Juan Skoko", "Walter Schmidt", "Felipe Galeano")
...
#se debe continuar con corrección manual de unos pocos campos, registros sin clara referencia a un nombre (por ejemplo los apodos como "cacho") por defecto es NA
brigada_vars$jefe_brigada<- ifelse(brigada_vars$jefe_brigada %in% nombres_jefes, brigada_vars$jefe_brigada, unlist(sapply(brigada_vars$jefe_brigada, function(x) switch(x, "agustin bruno acevdo" =  "Bruno Acevedo", "alejandro walter schmidt" = "Walter Schmidt" , "bogado" = "Bogado", "campo" = "Campos", "campos" = "Campos", "carignano" = "Carignano", "canignano" = "Carignano", "carigniano" = "Carignano", "carigñano" = "Carignano", "carlos josé fernandez" = "Carlos Fernandez", "castillo" = "Castillo", "control" = "DNB", "d'angelo" = "Pablo D'Angelo", "d'angelo" = "Pablo D'Angelo", "d'angelo >pablo" = "Pablo D'Angelo", "d,angelo" = "Pablo D'Angelo", "d`angelo" = "Pablo D'Angelo", "dangelo" = "Pablo D'Angelo", "dángelo"= "Pablo D'Angelo", "diaz diego" = "Diego Diaz", "favoretti" = "Santiago Favoretti", "favoretti.s" = "Santiago Favoretti", "fernandez deivid" = "Deivid Fernandez",  "florencia maria igarzabal" = "Florencia Igarzabal", "gonzales" = "Gonzales", "gonzalez" = "Gonzalez", "gonzalez f" =  "Federico Gonzalez", "gonzalez, sabrina" = "Sabrina Gonzalez", "justino jorge araujo" = "Jorge Araujo", "manuel juan solís" = "Juan Solis", "matias diego diaz" = "Diego Diaz", "mayol" = "Eduardo Mayol", "mestres" = "Mestres", "nadia" = "Nadia Griffiths", "piggot" = "Alejandro Piggot", "r gon." = "Ruben Gon", "rodriguez f" = "Fernando Rodriguez", "saiquita" = "Sergio Saiquita", "skoko" = "Juan Skoko", "skoko-sena" =  "Juan Skoko", "skoko - sena" = "Juan Skoko", "skoko jose juan" = "Juan Skoko", "alvarez deivid" = "David Alvarez", "camilo matias jaime" = "Matias Jaime",  "alfredo marcos gonzalez" = "Marcos Gonzalez", "angel miguel mamani" = "Miguel Mamani", "angelo d" = "Pablo D'Angelo", "arguimbao rul" = "Raul Arguimbao", "bruno agustin acenedo " = "Bruno Acevedo", "agustin bruno acenedo" = "Bruno Acevedo", "camignano" = "Carignano", "carlos jose fernandez" = "Jose Fernandez", "d' angelo" = "Pablo D'Angelo", "d'pabllo angelo" = "Pablo D'Angelo", "d'pablo angrlo" = "Pablo D'Angelo", "eichelberg eenzo" = "Renzo Eichelberger", "eiclerberg renzo"  = "Renzo Eichelberger", "feliepe esteche" = "Felipe Esteche", "francisco mattenet" = "Mauricio Mattenet", "g enzo. cmpos" = "Enzo Campos", "gon" = "Ruben Gon", "javier luis ritter" = "Luis Ritter", "josé fernández carlos" = "Jose Fernandez", "juam skoko jose" = "Juan Skoko", "ledesma torres" = "Sergio Ledesma", "ledesma torrez" = "Sergio Ledesma", "manuel juan solis" = "Juan Solis", "miguel maldonado/arriola nestor" = "Miguel Maldonado", "torres sergio ledesma" = "Sergio Ledesma", "torrez sergio ledesma" = "Sergio Ledesma", NA)), use.names = FALSE))
...
Los codigos de presencia de ganado provienen de la encuesta del Collect, se pueden revisar en el "Survey Designer". Existio un cambio en 2018 de encuesta, por eso existen multiples variables asociadas a la misma dimension y se deben normalizar los campos.
...
Los codigos de formas de vida y Productos Forestales No Madereros (PFNM) provienen de la encuesta del Collect, se pueden revisar en el "Survey Designer". Existio un cambio en 2018 de encuesta, por eso existen multiples variables asociadas a la misma dimension y se deben normalizar los campos.
Sugerencia: convendría cambiar el termino "formas de vida" (bien definido tecnicamente  y no corresponde con la categorias que se usaron en el inventario) a "diversidad de biota".
...
#write.table(var_UM_f, file = "C:\\Users\\Admin\\Desktop\\R inbn2\\informe_nac\\otras_variables_UM_todas_OFC_completa_correg.csv", row.names = FALSE, col.names = TRUE, quote = FALSE, sep = ",")

# write.table(tabla_sin_estepa, file = "C:\\Users\\Admin\\Desktop\\R inbn2\\informe_nac\\otras_variables_UM_sin_estepa_3.csv", row.names = FALSE, col.names = TRUE, quote = FALSE, sep = ",")

# write.table(tabla_estepa, file = "C:\\Users\\Admin\\Desktop\\R inbn2\\informe_nac\\otras_variables_UM_estepa_3.csv", row.names = FALSE, col.names = TRUE, quote = FALSE, sep = ",")

```

```{r, size="small" }

tabla_sin_estepa %>% group_by(formas_helechos, formas_cactaceas, formas_epifitas, formas_briofitas, formas_lianas, formas_orquideas, formas_orquideas, formas_gramineas, formas_otras) %>% summarise(count = n()) %>% arrange(desc(count))

funcion1 <- function(s){
tabla_sin_estepa %>% filter(region == s) %>% group_by(formas_helechos, formas_cactaceas, formas_epifitas, formas_briofitas, formas_lianas, formas_orquideas, formas_orquideas, formas_gramineas, formas_otras) %>% summarise(count = n()) %>% arrange(desc(count))}

for (reg in unique(tabla_sin_estepa$region)) {
...
tabla_sin_estepa %>% count(tipo_paisaje) 

funcion2 <- function(s){
tabla_sin_estepa %>% filter(region == s) %>% count(tipo_paisaje) 
  }
...
tabla_sin_estepa %>% count(PFNM_presencia_resumen != "sin registro")  
tabla_sin_estepa %>% count(PFNM_presencia_resumen, sort = TRUE)

funcion3 <- function(s){
print(tabla_sin_estepa %>% filter(region == s) %>% count(PFNM_presencia_resumen != "sin registro"))
print(tabla_sin_estepa %>% filter(region == s) %>% count(PFNM_presencia_resumen, sort = TRUE))
  }
